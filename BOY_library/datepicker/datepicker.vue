        ...
        <transition name="toggle">
            <div class="date-panel" v-show="panelState" :style="coordinates">
                <div class="panel-header" v-show="panelType !== 'year'">
                    <div class="arrow-left" v-bind:class="{ 'arrow-disable': tmpMonth === 0 }" @click="prevMonthPreview()">&lt;</div>
                    ...
                    <div class="arrow-right" v-bind:class="{ 'arrow-disable': tmpMonth === 11 }" @click="nextMonthPreview()">&gt;</div>
                </div>
                <div class="panel-header" v-show="panelType === 'year'">
