<template lang="html">
  ...
  <form class="col-sm-6 col-sm-offset-3" v-cloak>
  	...
  	<ul>
        ...
        v-bind:class="{ 'active': service.active }">
  			...
  			{{service.name}} <span v-show="service.active" class="label label-success"> Selected</span> <span class="price">{{ service.price | currency }}</span>
  		</li>
  	</ul>
